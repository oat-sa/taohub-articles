...
Upon instantiation, a state is given the reference of the widget it represents.
...
Within a state, you have access to the 
$form by this.widget.
$form property, which is the container of the form.
