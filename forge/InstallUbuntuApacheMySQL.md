...
The first step of the installation of our environment is to install the Apache2 web server. To do so, open up a terminal and type the following command lines. The *apt-get update* command aims at updating your system. You can skip this command if you think your system is up to date.
...
-   [Apache directives](resources/http://httpd.apache.org/docs/2.4/mod/core.html)
-   [Apache virtual hosting](resources/http://httpd.apache.org/docs/2.4/vhosts/)
...
We will now download the latest version of the TAO source code and deploy it on the web server. Go to the official TAO download page and download the last [Stable Release](resources/http://tao-assessment.com/resources/download-tao).
