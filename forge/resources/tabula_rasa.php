...
$fsManager = $serviceManager->get('generis/FsManager');

foreach (array($fsManager->getFileSystem($config['private']), $fsManager->getFileSystem($config['public'])) as $fs) {
    $path = $fs->getPath();
...
// deliveryExecutions
$deliveryService = $serviceManager->get('taoDelivery/execution_service');
