...
-   the *LoadModule rewrite_module modules/mod_rewrite.so* directive exists in your httpd.conf configuration file. Remove any comment sign (‘<br/>
#’) if it is the first character of the related line.
...
-   [mysql](http://us.php.net/manual/en/book.mysql.php), [mysqli](http://us.php.net/manual/en/book.mysqli.php), [pdo_mysql](http://us.php.net/manual/en/ref.pdo-mysql.php) or [pgsql](http://us.php.net/manual/en/book.pgsql.php)
