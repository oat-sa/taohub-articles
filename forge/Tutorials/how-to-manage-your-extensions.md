...
The TAOExtensions script can be accessed by CLI on your web server. It is located at *PATH_TO_PLATFORM/tao/scripts/taoExtensions.php*. It provides multiple *actions* you can call to install or configure your extensions.
