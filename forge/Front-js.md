...
[Require.js](resources/http://requirejs.org/) is the framework used by TAO to structure client side code.\
The JavaScript code is split into web modules using the [AMD](resources/http://en.wikipedia.org/wiki/Asynchronous_module_definition) (Asynchronous module definition) standard.
...
The request parameters sent along with the Ajax request are by default available inside the controller. By example, a call to `/taoItems/ItemPreview/index?itemId=24` gives you an access to the `itemId` parameter. You can get from the [module configuration](resources/http://requirejs.org/docs/api.html#config-moduleconfig) :
...
Some libraries can change your life, some of them are available:
  ...
  ------------- -------------------------------------------- ---------------------- ---------------------------------------- -------------------------------------------------
  jQuery        Cross browser DOM and Ajax utility library   1.8.0                  http://jquery.com                        [MIT](resources/http://opensource.org/licenses/MIT)
  jQuery UI     UI Components library                        1.8.23                 http://jqueryui.com/                     [MIT](resources/http://opensource.org/licenses/MIT)
  qUnit         Client side unit testing                     1.12.0                 http://qunitjs.com                       [MIT](resources/http://opensource.org/licenses/MIT)
  Lo-dash       functional sugar and utilities               2.2.1                  http://lodash.com                        [MIT](resources/http://opensource.org/licenses/MIT)
  Async         Async utilities                              0.2.10                 https://github.com/caolan/async          [MIT](resources/http://opensource.org/licenses/MIT)
  Require.js    AMD implementation and loader                2.1.9                  http://requirejs.org                     [MIT](resources/http://opensource.org/licenses/MIT)
  Handlebars    Awesome client side templates                1.0.0                  http://handlebarsjs.com/                 [MIT](resources/http://opensource.org/licenses/MIT)
  Moment        date, time, duration utility                 2.4.0                  http://momentjs.com                      [MIT](resources/http://opensource.org/licenses/MIT)
  Raphael       JavaScript Vector Library                    2.1.1                  http://raphaeljs.com                     [MIT](resources/http://opensource.org/licenses/MIT)
  CKEditor      Wysiwyg editor                               4.3.1                  http://ckeditor.com                      [GPLv2](resources/http://opensource.org/licenses/GPL-2.0)
  Select2       Styled select boxes                          3.4.5                  http://ivaynberg.github.io/select2/      [GPLv2](resources/http://opensource.org/licenses/GPL-2.0)
  Tooltipster   Hipe tooltips                                3.1.4                  http://iamceege.github.io/tooltipster/   [MIT](resources/http://opensource.org/licenses/MIT)

(\*) Check the code, as it is difficult to maintain without a dependency manager like [Bower](resources/http://bower.io)
