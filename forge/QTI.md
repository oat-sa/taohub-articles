...
\* Import QTI Item (XML files compatible with [QTI 2.0](resources/http://www.imsglobal.org/question/qti_v2p0/imsqti_infov2p0.html) or [QTI 2.1](resources/http://www.imsglobal.org/question/qtiv2p1/imsqti_infov2p1.html))\
 \* Import QTI Package (ZIP files compatible with [IMS Content Packaging v1.1.4](resources/http://www.imsglobal.org/content/packaging/cpv1p1p4/imscp_infov1p1p4.html))\
 \* Save the item content in the QTI format (XML)\
 \* Create or edit a QTI Item ([QTI 2.1](resources/http://www.imsglobal.org/question/qtiv2p1/imsqti_infov2p1.html))\
 \* Export item to XML file ([QTI 2.1](resources/http://www.imsglobal.org/question/qtiv2p1/imsqti_infov2p1.html))\
 \* Export one or more items to zip package ([QTI 2.1](resources/http://www.imsglobal.org/question/qtiv2p1/imsqti_infov2p1.html))\
...
-   [Specification documents version 2.1](resources/http://www.imsglobal.org/question/index.html)
-   [Implementation guide](resources/http://www.imsglobal.org/question/qtiv2p1/imsqti_implv2p1.html)
-   [Information model](resources/http://www.imsglobal.org/question/qtiv2p1/imsqti_infov2p1.html)
...
![](resources/http://forge.taotesting.com/attachments/2627/taoQTImodels.png)
...
You can find the complete source code documentation in the [PHP Doc](resources/http://forge.tao.lu/docs/phpdoc/index.html) (Package: *taoQTI*, SubPackage: *models\_classes\_QTI*)
...
The base proposal from IMS is a draft version subimitted to IMS members for review. [IMS initial PCI proposal](resources/http://www.imsglobal.org/assessment/pciv1p0cf/imsPCIv1p0cf.html)

The proposal form Passific Metrics attempts to solve some issues from the original proposal with the introduction of the concept of “shared libraries” and a better structured XML serialization of PCIs. [Proposal from Pacific Metrics](resources/http://www.imsglobal.org/assessment/PCI_Change_Request_v1pd.html)
