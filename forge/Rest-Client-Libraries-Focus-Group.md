...
-   Java
-   Python
-   JavaScript (client - TAO needs to implement [CORS](resources/http://enable-cors.org/) )
...
![](resources/http://forge.taotesting.com/attachments/download/2622/rest-arch.png)
