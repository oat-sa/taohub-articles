...
You can contribute to the translation effort of TAO in the dedicated platform http://translate.taotesting.com . We choose to use the open source toolkit [Pootle](resources/http://translate.sourceforge.net/wiki/). Pootle user howto is available [here](resources/http://translate.sourceforge.net/wiki/users/howto) .
...
There is a also [dedicated section](resources/http://forge.taotesting.com/projects/tao/boards/3) of the forum to speak about translation, if you have any questions or feedback or if you want to take the lead on a new language translation. Do not hesitate to contact us. You may also contact us to start a translation in a new language. We will then generate the new translation file and make them available in Pootle.
...
-   [the Gettext manual](resources/http://www.gnu.org/software/gettext/manual/gettext.html)
-   [the PO file format](resources/http://www.gnu.org/software/gettext/manual/gettext.html#PO-Files)
