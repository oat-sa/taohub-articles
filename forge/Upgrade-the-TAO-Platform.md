...
1.  Download the attached file [taoUpdate](resources/http://releases.taotesting.com/taoUpdate2.5-2.6.zip) and extracted in content in your root folder.
...
If you require an offline upgrade, simply copy the standard package [TAO\_2.6\_build.zip](resources/http://releases.taotesting.com/TAO_2.6_build.zip) in the folder taoUpdate/data/local/ . It will then follow same procedure that the online update.
