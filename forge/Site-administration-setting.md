...
The `htpasswd` command is provided by Apache. You can have a look at [documentation page](resources/http://httpd.apache.org/docs/current/programs/htpasswd.html) .
