...
The wfEngine extension also provides other services and helpers to help building processes. Below is a short introduction to them. For more information, please refer to the [phpDoc](resources/http://forge.tao.lu/docs/phpdoc/index.html) **package wfEngine**
...
You can find more details about the workflow services presented in this page in the [phpDoc](resources/http://forge.tao.lu/docs/phpdoc/index.html)
