...
The base proposal from IMS is a draft version subimitted to IMS members for review. [IMS initial PCI proposal](resources/http://www.imsglobal.org/assessment/pciv1p0cf/imsPCIv1p0cf.html#_Toc353965343)\
The proposal form Passific Metrics attempts to solve some issues from the original proposal with the introduction of the concept of “shared libraries” and a better structured XML serialization of PCIs. [Pacific Metrics proposal](resources/http://www.imsglobal.org/assessment/PCI_Change_Request_v1pd.html)
...
First, let’s have a look at a sample implementation available at [qtiItemPci/views/js/pciCreator/dev/likertScaleInteraction](resources/https://github.com/oat-sa/extension-tao-itemqti-pci/tree/develop/views/js/pciCreator/dev/likertScaleInteraction).
...
It is an especially useful helper located at [taoQtiItem/qtiCreator/editor/customInteractionRegistry](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/editor/customInteractionRegistry.js)\
...
The Portable Info Control registry is located at [taoQtiItem/qtiCreator/editor/infoControlRegistry.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/editor/infoControlRegistry.js)
...
portableCustomInteraction : [qtiCreator/model/interactions/PortableCustomInteraction.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/model/interactions/PortableCustomInteraction.js)\
containerHelper : [qtiCreator/model/helper/container.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/model/helper/container.js)\
registry : [qtiCreator/editor/customInteractionRegistry.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/editor/customInteractionRegistry.js)\
creatorRenderer : [qtiCreator/renderers/interactions/PortableCustomInteraction.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/renderers/interactions/PortableCustomInteraction.js)\
creator Widget : the one returned by pciCreator.getWidget(), e.g. [a sample implementation](resources/https://github.com/oat-sa/extension-tao-itemqti-pci/blob/master/views/js/pciCreator/dev/likertScaleInteraction/widget/Widget.js)\
commonRender : [qtiCommonRenderer/renderers/interactions/PortableCustomInteraction.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCommonRenderer/renderers/interactions/PortableCustomInteraction.js)\
...
![](resources/http://forge.taotesting.com/attachments/download/3430/pciCreatorSequence.png)

### For PIC :

The same principle applies.\
The members and locations are :\
portableInfoControl : [qtiCreator/model/PortableInfoControl.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/model/PortableInfoControl.js)\
containerHelper : [qtiCreator/model/helper/container.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/model/helper/container.js)\
registry : [qtiCreator/editor/infoControlRegistry.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/editor/infoControlRegistry.js)\
creatorRenderer : [qtiCreator/renderers/PortableInfoControl.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCreator/renderers/PortableInfoControl.js)\
creator Widget : the one returned by picCreator.getWidget(), e.g. [a sample implementation](resources/https://github.com/oat-sa/extension-tao-itemqti-pic/blob/develop/views/js/picCreator/dev/studentToolSample/creator/widget/Widget.js)\
commonRender : [qtiCommonRenderer/renderers/PortableInfoControl.js](resources/https://github.com/oat-sa/extension-tao-itemqti/blob/develop/views/js/qtiCommonRenderer/renderers/PortableInfoControl.js)
...
3 : a mix of them\
See an example of call to widget refresh() in [qtiItemPci/views/js/pciCreator/dev/likertScaleInteraction/creator/widget/states/Question.js](resources/https://github.com/oat-sa/extension-tao-itemqti-pci/blob/develop/views/js/pciCreator/dev/likertScaleInteraction/creator/widget/states/Question.js)
